...
class Swipe extends Component {
  ...
  saveProfile = async () => {
    if(this.state.picture0 == "null" || this.state.picture0 == null || this.state.picture0 == "" || GLOBAL.profileCreate.firstname_display == "" || GLOBAL.profileCreate.firstname_display == "null" || GLOBAL.profileCreate.program == "" || GLOBAL.profileCreate.program == null || GLOBAL.profileCreate.program == "null" || GLOBAL.profileCreate.year == "" || GLOBAL.profileCreate.year == "null" || GLOBAL.profileCreate.year == null || this.state.pronounsToSave == ""){
      ...
      GLOBAL.profileCreate.pronouns = this.cleanSmartPunctuation(this.state.pronounsToSave);
        ...
        formBody = formBody.join("&");
        return fetch('https://rumine.ca/_apiv2/gw/fp/c', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
          },
            ...
            if(responseJson == "logout"){
              ...
              alert("There was an error with the data. Please fill in the steps again.");
                ...
                if(responseJson.token != "NA"){
                  ...
                  'firstname_display': GLOBAL.profileCreate.firstname_display,
                  ...
                  Actions.replace("swipe", {firstTimeFriends: true});
                }
              }
        })
        .catch((error) => {
        ...
        />
          <View style={{height: 'auto', width: screenWidth, borderRadius: 20, backgroundColor: 'white'}}>
            ...
            <View style={{position: "absolute", top: 50, width: screenWidth, height: 5}}>
              <View style={{height: '100%', width: this.state.stepNum*(screenWidth/2), backgroundColor: "#5bb8ff"}}>
              </View>
            </View>
            <ScrollView>
              {(this.state.stepNum == 1)?
              <View style={{minHeight: screenHeight}}>
                <View  style={{ marginTop:30, marginLeft: 15, height : 50, width : 110,backgroundColor: "#5bb8ff"}}>
                ...
                <Text style={{fontSize: 26, paddingTop: 5, paddingBottom: 20, paddingLeft: 15, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>Background Info</Text>


                <Text style={{fontSize: 20, paddingTop: 20, paddingBottom: 20, paddingLeft: 17, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>My first name is...</Text>
                <TextInput
                  placeholder="First name"
                  value={this.state.nameToSave}
                  keyboardType={Platform.OS === 'ios' ? 'ascii-capable' : 'visible-password'}
                  placeholderTextColor="#aaaaaa"
                  style={{color: "black", padding: 10, fontSize: 25, width: screenWidth*0.9, left: screenWidth*0.05, backgroundColor: "white", borderRadius: 10, borderColor: "#5bb8ff", borderWidth: 2}}
                  multiline={false}
                  maxLength={32}
                  onChangeText={(name) => this._handleNameChange(name)}
                  >
                </TextInput>
                <Text style={{fontSize: 20, paddingTop: 20, paddingBottom: 20, paddingLeft: 17, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>My last name is...</Text>
                <TextInput
                ...
                <Text style={{fontSize: 12, paddingLeft: 20, textAlign: "left", color: "black", fontFamily: "Raleway-Medium"}}>Your last name will appear in searches, groups, and group chats.</Text>
                <Text style={{fontSize: 20, paddingTop: 20, paddingBottom: 20, paddingLeft: 15, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>My birthday is:</Text>
                <DatePicker
                  style={{backgroundColor: "white", width: screenWidth*0.93, left: screenWidth*0.04, borderWidth: 2, borderRadius: 10, borderColor: "#5bb8ff"}}
                ...
                />
                <Text style={{fontSize: 20, paddingTop: 20, paddingBottom: 20, paddingLeft: 15, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>My program is:</Text>
                <RNPickerSelect
                  ...
                  style={{ inputIOS: {fontSize: 20, color: "black", fontSize: 18, padding: 10, backgroundColor: "white", borderWidth: 2, borderRadius: 10, borderColor: "#5bb8ff", width: screenWidth*0.9, left: screenWidth*0.05}}}
                />
                <Text style={{fontSize: 20, paddingTop: 20, paddingBottom: 20, paddingLeft: 15, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>Which year are you in?</Text>
                <RNPickerSelect
                ...
                <View style = {{marginTop: 25, flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                  ...
                  <TouchableOpacity activeOpacity={0.8} onPress={() => this.saveStep1()} style={{height: 60, width: screenWidth*0.5, backgroundColor: "#5bb8ff", borderRadius: 25, justifyContent: "center", alignItems: "center"}}>
              ...
              <View style={{minHeight: screenHeight}}>
                ...
                <Text style={{fontSize: 26, paddingTop: 5, paddingBottom: 20, paddingLeft: 15, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>My Profile</Text>

                <Text style={{fontSize: 20, paddingTop: 30, paddingBottom: 20, paddingLeft: 15, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>Here's a picture of me:</Text>
                <TouchableOpacity style={{height: 'auto', width: 'auto'}} onPress={() => this.selectPicture(0)} activeOpacity={0.8}>
                  <FastImage onLoadStart={() => this.setState({pictureLoading: true})} onLoadEnd={() => this.setState({pictureLoading: false})} source={{uri: 'https://rumine.ca/_i/s/i.php?i=' + this.state.picture0, priority: FastImage.priority.normal}} style={{justifyContent: "center", alignItems: "center", backgroundColor: "gray", height: screenHeight*0.75, width: screenWidth}}>
                    {(this.state.pictureLoading)?<ActivityIndicator size="large" color="#5bb8ff" />:<View></View>}
                ...
                <Text style={{fontSize: 20, paddingTop: 30, paddingBottom: 20, paddingLeft: 20, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>Create your bio:</Text>
                <TextInput
                  placeholder="Bio"
                  value={this.state.bioToSave}
                  placeholderTextColor="#aaaaaa"
                  style={{color: "black", padding: 10, fontSize: 20, width: screenWidth*0.9, left: screenWidth*0.05, backgroundColor: "white", borderRadius: 10, borderColor: "#5bb8ff", borderWidth: 2}}
                  multiline={true}
                  maxLength={1024}
                  onChangeText={(bio) => this._handleBioChange(bio)}
                  >
                  </TextInput>
                  <Text style={{fontSize: 20, paddingTop: 30, paddingBottom: 20, paddingLeft: 20, textAlign: "left", color: "#5bb8ff", fontFamily: "Raleway-Bold"}}>My Pronouns are:</Text>
                  <TextInput
                  ...
                  <View style = {{marginTop: 25, flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                    ...
                    <TouchableOpacity activeOpacity={0.8} onPress={() => this.saveProfile()} style={{height: 60, width: screenWidth*0.5, backgroundColor: "#5bb8ff", borderRadius: 25, justifyContent: "center", alignItems: "center"}}>
