/** This replaces the file in react-native-gifted-chat **/
import PropTypes from 'prop-types';
import React from 'react';
import { Platform, StyleSheet, View, SafeAreaView, KeyboardAvoidingView, findNodeHandle } from 'react-native';
...
class GiftedChat extends React.Component {
    ...
    renderMessages() {
        ...
        <MessageContainer scrollEnabled={this.props.scrollEnabled} {...messagesContainerProps} invertibleScrollViewProps={this.invertibleScrollViewProps} messages={this.getMessages()} forwardRef={this._messageContainerRef}/>
