/** This goes in react-native-swipe-cards **/
'use strict';
...
export default class SwipeCards extends Component {
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (e, {vx, vy, dx, dy}) => {
        ...
        if (hasSwipedHorizontally || (hasSwipedVertically && this.props.hasMaybeAction)) {
          ...
          card_filter[this.state.cards[currentIndex[this.guid]].userid] = true;
  ...
  _goBackCard() {
    ...
    else if(currentIndex[this.guid] > this.state.cards.length){
      this.setState({
  ...
  _goToNextCard() {
    currentIndex[this.guid]++;
    if(this.state.cards[currentIndex[this.guid]] === undefined){
      this.props.setRequiresRefresh();
      this.props.cardRemoved(currentIndex[this.guid]);
      return 0;
    }
    while(this.state.cards[currentIndex[this.guid]] !== undefined && card_filter[this.state.cards[currentIndex[this.guid]].userid]){
      currentIndex[this.guid]++;
    }
    if(this.state.cards[currentIndex[this.guid]] === undefined){
      this.props.setRequiresRefresh();
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.cards !== this.props.cards) {
      ...
      if(this.props.requiresRefresh){
        currentIndex[this.guid] = 0;
      }

      if(nextProps.cards.length > 0){
        if(nextProps.cards[currentIndex[this.guid]] === undefined){
          this.props.setRequiresRefresh();
          this.props.cardRemoved(currentIndex[this.guid]);
          return 0;
        }
        while(nextProps.cards[currentIndex[this.guid]] !== undefined && card_filter[nextProps.cards[currentIndex[this.guid]].userid]){
          currentIndex[this.guid]++;
        }
        if(nextProps.cards[currentIndex[this.guid]] === undefined){
          this.props.setRequiresRefresh();
      ...
      this.setState({
        ...
        if(this.props.requiresRefresh){
          if(this.state.cards.length > 0){
            this._resetState();
            this.props.resetRequiresRefresh();
          }
        }
