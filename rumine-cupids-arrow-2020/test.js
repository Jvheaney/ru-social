        ...
        Rb("auth", {
            callback: function() {
                ...
                d.checkSessionState(e, function(f) {
                    ...
                    Yb("savedUserState", g);
                    (k || h) && dc(f) && !Q("disableRealtimeCallback") && d._pimf(f,
                        !0)
                })
            }
        });
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.xh-S9KbEGSE.O/am\u003dwQc/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCNaUSRWzhd71dAsiMVOstVE3KcJZw/m\u003d__features__",
